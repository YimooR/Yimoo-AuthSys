...
import top.yimoorua.system.custom.CustomMd5Password;
import top.yimoorua.system.filter.TokenAuthenticationFilter;
import top.yimoorua.system.filter.TokenLoginFilter;
 ...
 * @EnableGlobalMethodSecurity 开启注解功能，默认禁用注解
 */
@Configuration
@EnableWebSecurity
